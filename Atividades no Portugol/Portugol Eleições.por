programa
{
	funcao inicio()
	{
		...
		cadeia candidatoa 
		cadeia candidatob, resposta 
		


		escreva("Quantos canditados serão? \n")
		leia(quantidade)
		se(quantidade < 2){
			escreva("erro \n")
		  inicio()
		}	
		 escreva("Escreva o primero candidato candidato \n")
		 leia(candidatoa)
		 escreva("Escreva o segundo candidato \n")
		 leia(candidatob)
		...
		faca
		{
			...
			escreva("Escolha seus candidatos ou tecle zero para encerrar\n\n")
		...
		se (total_votos > 0)
		{
			...
			escreva("Deseja fazer uam nova eleição? \n")
